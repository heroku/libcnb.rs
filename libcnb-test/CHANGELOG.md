...
- Replaced `container_context::ContainerExecResult` with `log::LogOutput` which is now shared with `ContainerContext::logs` and `ContainerContext::logs_follow`. ([#366](https://github.com/Malax/libcnb.rs/pull/366))
